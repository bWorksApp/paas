...
const ContractPieChart = () => {
  ...
  React.useEffect(() => {
    dataProvider
      .customMethod("customapis/sumcontractandtxbyuser", { filter: {} }, "GET")
    ...
    <Card>
      ...
      {isAuthenticated && (
        <CardHeader
          ...
          subheader={
            <Typography variant="subtitle2" gutterBottom>
              {`Plutus contracts: ${userData.plutusContracts}, Aiken contracts: ${userData.aikenContracts}, Marlowe contracts: ${userData.marloweContracts}, Has dApp Tx contracts: ${userData.hasTxContracts}`}
            </Typography>
          }
        />
      )}
